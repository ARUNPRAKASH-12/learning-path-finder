        ...
        return (
            <div className="min-h-screen flex items-center justify-center">
                <div className="text-center">
                    ...
                    <h2 className="mt-4 text-xl font-semibold">AI is analyzing your selected path...</h2>
                    <p className="mt-2 text-gray-600">This might take a minute</p>
                </div>
            </div>
        );
    }
            ...
            {analysis && (
                <div className="space-y-8">
                    ...
                    <div className="bg-white p-6 rounded-lg shadow-md">
                        ...
                        <p className="text-gray-600">{analysis.estimatedTimeline}</p>
                    </div>
